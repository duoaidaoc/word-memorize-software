...
int main(int argc, char *argv[])
{
    ...
    if (sel < 6 || sel >= 19) {
        ...
        glob_login_bg_path = "../database_crouse_design/pics/night_bg";
        glob_hello = "晚上好啊！";
    } else if (sel < 14) {
        //上午
        glob_stylecss_path = "../database_crouse_design/morning.css";
        glob_login_bg_path = "../database_crouse_design/pics/morning_bg";
        glob_hello = "上午好啊！";
    } else if (sel < 19) {
        //下午
        glob_stylecss_path = "../database_crouse_design/afternoon.css";
        glob_login_bg_path = "../database_crouse_design/pics/afternoon_bg";
        glob_hello = "下午好啊！";
    }
